  ...
  return (
    <div className="bg-mainwhite">
      <div className="mx-auto max-w-2xl py-2 sm:px-6 sm:py-0 lg:px-8">
        <div className="flex justify-center relative isolate overflow-hidden bg-mainblack shadow-2xl sm:rounded-3xl lg:flex lg:gap-x-20">
          <svg
            viewBox="0 0 1024 1024"
            className="absolute top-0 left-0 -z-10 h-[64rem] w-[64rem] -translate-y-1/2 [mask-image:radial-gradient(closest-side,white,transparent)] sm:left-full sm:-ml-80 lg:left-1/2 lg:ml-0 lg:translate-y-0 lg:-translate-x-1/2"
            aria-hidden="true"
          >
            <circle
              cx={512}
